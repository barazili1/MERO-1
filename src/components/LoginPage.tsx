    ...
    <div className="flex flex-col h-[100dvh] max-w-md mx-auto px-6 py-8 bg-transparent relative overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-10 sm:mb-16 px-4 py-3 glass rounded-2xl">
        ...
        <div className="flex items-center gap-2">
          <motion.div
            ...
            className="w-2.5 h-2.5 rounded-full bg-crimson red-glow"
          />
      ...
      <div className="flex-1 flex flex-col items-center justify-center -mt-12">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-5xl font-black font-orbitron text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40 tracking-tighter text-center">
        ...
        >
          <div className="space-y-2">
            ...
            <div className="relative group">
              <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                <Lock className="w-5 h-5 text-white/20 group-focus-within:text-crimson transition-colors" />
              </div>
              <input
                type="password"
                value={passwordValue}
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-white placeholder:text-white/20 focus:outline-none focus:ring-2 focus:ring-crimson/50 focus:border-crimson transition-all"
              />
            </div>
          </div>
          ...
          <button 
            ...
            className="w-full py-4 bg-gradient-to-r from-crimson to-crimson-dark rounded-2xl font-bold tracking-widest text-white red-glow-heavy hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-50 disabled:grayscale disabled:cursor-not-allowed group flex items-center justify-center gap-2"
          >
            LOGIN TO SYSTEM
      ...
      >
        ...
        <button 
          ...
          className="flex items-center gap-2 px-8 py-3 bg-white/5 hover:bg-white/10 rounded-full border border-white/10 text-crimson font-bold text-sm tracking-wider transition-all"
        >
          GET PASSWORD
